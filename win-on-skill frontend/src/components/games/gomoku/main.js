...
export default class Board extends React.Component{
  ...
  render(){
    ...
    return (
      ...
      <h2><a href="https://en.wikipedia.org/wiki/Gomoku" style={{textDecoration:"none"}}>GOMOKU</a></h2>
      <h6><a href="https://www.youtube.com/watch?v=5PTXdR8hLlQ" target="_blank">How to play Gomoku</a></h6>
